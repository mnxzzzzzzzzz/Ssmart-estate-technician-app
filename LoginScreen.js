  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (user) {
        ...
        await AsyncStorage.setItem('technicianId', user.id);
        await AsyncStorage.setItem('technicianName', user.name);
        
        // Navigate to Main App (which will show the Dashboard in HomeTab)
